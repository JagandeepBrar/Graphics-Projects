...
public:
	...
	int		getOctreeDepth() const { return m_nOctreeDepth; }
	bool	getDebuggingStatus() const { return m_displayDebuggingInfo; }
	bool	getOctreeStatus() const { return m_useOctreeAcceleration; }
...
protected:
	...
	int			m_nOctreeDepth;			// Max depth of the octree

	// Determines whether or not to show debugging information
	// for individual rays.  Disabled by default for efficiency
	// reasons.
	bool		m_displayDebuggingInfo;
	bool		m_useOctreeAcceleration;
