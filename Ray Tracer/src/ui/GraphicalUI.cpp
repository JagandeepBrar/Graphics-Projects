...
{
	fl_message("Ray-Tracer Project, by Jagandeep Brar - 7739801, University of Manitoba.");
}
...
void GraphicalUI::cb_useOctreeCheckButton(Fl_Widget* o, void* v)
{
	GraphicalUI* pUI=(GraphicalUI*)(o->user_data());
	pUI->m_useOctreeAcceleration = (((Fl_Check_Button*)o)->value() == 1);
}
...
GraphicalUI::GraphicalUI() {
	...
	m_mainWindow = new Fl_Window(100, 40, 350, 310, "Ray <Not Loaded>");
        ...
        m_debuggingDisplayCheckButton = new Fl_Check_Button(10, 280, 180, 20, "Debugging display");
		...
		// set up the octree usage checkbox
		m_useOctreeCheckButton = new Fl_Check_Button(10, 255, 180, 20, "Use Octree Acceleration");
		m_useOctreeCheckButton->user_data((void*)(this));
		m_useOctreeCheckButton->callback(cb_useOctreeCheckButton);
		m_useOctreeCheckButton->value(m_useOctreeAcceleration);
